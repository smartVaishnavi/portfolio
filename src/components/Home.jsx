...
import heroinImage from "../assets/heroinImage.jpg";
...
<p className="text-gray-500 py-4 max-w-md">I love to work on web application using
react ,javascrit, java.
</p>
<div>
 <Link to=" Portfolio" smooth duration={500} className="group text-white w-fit px-6 py-3 my-2
 flex itmes-center rounded-md bg-gradient-to-r
...
<div> <img src={heroinImage} alt=" my profile"
